                ...
                <div class="dash-direct">
                  ...
                  <table class="table team-table">
                    <tbody>
                      ...
                      <tr class="table-gray">
                        <th>Matched</th>
                        <td>{userData?.totalLeftCount>userData?.totalRightCount ? userData?.totalRightCount :"0"   }</td>
                        <td>{userData?.totalRightCount>userData?.totalLeftCount ? userData?.totalLeftCount : "0"  }</td>
                      </tr>
                      <tr>
